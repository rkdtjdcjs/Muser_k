              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
                ...
                <div class="U_Edge">
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-3 col-lg-3 " align="center"><img src="../resources/img/MS.png" class="img img-rounded img-fluid" >
                      <br><br><a href="<c:url value='/member/MemberModify?muId=${member.muId}'/>" class="btn-primary1">내 정보 수정</a> 
                      ...
                      <div class=" col-md-9 col-lg-9 "> 
                        ...
                        <a href="<c:url value='/cart/cartList'/>" class="btn-primary1">구매 목록</a>
                        <a href="<c:url value='/reservation/reservationAll'/>" class="btn-primary1">예약 목록</a>
                        </div>
                      </div>
                    </div>
                  </div>
