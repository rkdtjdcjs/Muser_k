...
<!--===============================================================================================-->
	<link rel="stylesheet" href="<c:url value='/resources/css/util.css'/>" type="text/css" />
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('img/hero/hero-21.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter userid">
						...
						<button type="button"  class="btn btn-link" id="duplicateCheck" onclick="idOverlap()"> 중복확인</button>
						</label>
						<input type="text" name="muId" id="muId" size="85" placeholder="ID" required="required" maxlength="12">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Email">
						<input class="input100" type="email" name="Em" placeholder="Email">
						<span class="focus-input100" data-placeholder="&#9993;"></span>
					</div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter Name">
						...
						<span class="focus-input100" data-placeholder="&#8501;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Phone">
						<input class="input100" type="tel" name="Pone" placeholder="전화번호 ( - ) 생략">
						<span class="focus-input100" data-placeholder="&#9743;"></span>
					</div>


					<div class="wrap-input100 validate-input" data-validate="Enter Address">
						<input class="input100" type="text" name="Adr" placeholder="주소">
					   <span class="focus-input100" data-placeholder="&#10224;"></span>
				   </div>
